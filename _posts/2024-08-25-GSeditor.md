...
- `Edit loss` :  
  ...
  1) DreamFusion의 SDS loss처럼 3D model의 noised rendering과 other conditions를 2D diffusion model에 넣어준 뒤, diffusion model이 내놓은 score가 3D model의 업데이트 방향을 guide  
