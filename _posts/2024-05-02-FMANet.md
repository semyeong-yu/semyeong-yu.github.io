...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2024-05-02-FMANet/6.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
- Design of FMA-Net  
the number of multi-flow-mask pairs $$n$$ $$\propto$$ performance in $$Net^{R}$$  
using motion info. from multi-flow-mask pairs $$\boldsymbol f$$ is better than from DCN (Deformable Conv.)  
It's because 
