...
1. 3D coordinate x => 8 fc-layers => volume-density and 256-dim. feature vector
...
2. feature vector is concatenated with direction d => 1 fc-layer => view-dependent RGB color
...
$$\begin{matrix} u \\ v \\ 1 \end{matrix} = \begin{matrix} 1/f_x & 0 & W/2 \\ 0 & 1/f_y & H/2 \\ 0 & 0 & 1 \end{matrix} \begin{matrix} x \\ y \\ 1 \end{matrix}$$
