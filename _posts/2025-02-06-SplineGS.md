...
- summary :  
  ...
  - `COLMAP-free` novel spatio-temporal view synthesis for `dynamic` scenes from `in-the-wild monocular` videos, `thousands` time faster than SOTA  
  by applying `spline-based` model (MAS) to dynamic `3DGS trajectories`
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-02-06-SplineGS/11.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-02-06-SplineGS/13.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-02-06-SplineGS/14.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-02-06-SplineGS/12.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
