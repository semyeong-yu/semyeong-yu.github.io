...
main model  
  - recon. at `arbitrary target (bullet) timestamp`  
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/5.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
- Dynamic Novel-View-Synthesis (Quantitative) :  
  ...
  - NVIDIA Dynamic Scene Benchmark <d-cite key="75">[19]</d-cite> :  
    - dataset :  
    DyCheck iPhone dataset (9 dynamic scenes by 12 forward-facing synchronized cameras)  
    - baseline :  
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/6.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/8.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/7.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/10.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/9.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/12.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/11.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
- Ablation 4) NTE Module :  
  ...
  - BTimer 없이 NTE Module만 쓰면  
  TBD

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2025-01-10-BTimer/13.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
NTE Module output이 부정확하면 drift 연쇄적으로 BTimer의 결과에도 악영향 미칠 듯  
refinement, uncertainty 등으로 NTE Module output의 부정확성을 감소시켜 성능 높일 수 있을까?

- A2 :  
TBD

- Q3 :  
limitation 중에 unseen region은 recon.하지 못한다는 게 있는데  
