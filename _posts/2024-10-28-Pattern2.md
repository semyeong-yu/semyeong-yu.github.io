...
not unique for partition
  ...
  $$I(t) = \phi (P(w_{1} | t), \cdots, P(w_{c} | t))$$ where $$\sum_{i=1}^{c} P(w_{i} | t) = 1$$  
    ...
    - parent node에서 child node로 옮겼을 때 impurity가 많이 감소할수록 잘 split한 것임  
