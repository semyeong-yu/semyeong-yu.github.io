...
tags: cv
categories: cv-tasks
thumbnail: assets/img/2024-10-28-Pattern2/1.png
...
- 방법 1) 1-norm-soft-margin  
  ...
  subject to $$\xi_{i}, \mu_{i}, \lambda_{i} \geq 0$$  
    ...
    - $$\nabla_{\xi} L = 0 \rightarrow C - \mu_{i} - \lambda_{i} = 0$$
