...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2024-10-08-NeRFW/8.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
- A1 :  
Coarse Model(static network 사용)과 Fine Model(static, transient network 모두 사용)을 two-stage로 분리해서 학습하기 때문에  
multi-head 느낌으로 보면 transient head (transient embedding을 넣은 transient network)가 동적인 물체를 식별하는 역할을 잘 수행할 수 있을 것이다  
