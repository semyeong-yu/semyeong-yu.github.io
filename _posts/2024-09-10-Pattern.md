...
- Gaussian likelihood :  
  - unknown $$\mu$$ :  
    ...
    - Summary :  
      ...
      - $$\text{lim}_{N \rightarrow \infty}(\hat \mu_{\text{MLE}}) = E[\hat \mu_{\text{MLE}}] = \mu$$  
