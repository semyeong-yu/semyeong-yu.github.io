...
- decision rule :  
  - goal :  
  $$g(\boldsymbol x) = \text{sign}(\boldsymbol w^{T} \boldsymbol x + b)$$ 에서  
  choose decision boundary $$\boldsymbol w, b$$ that maximizes the margin  
  (margin은 support vectors(extreme vectors)가 결정)
  - TBD 11p
