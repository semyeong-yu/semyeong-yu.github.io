...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/2024-10-11-3DGScode/???.PNG" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    render()
...
<div class="caption">
    diff_gaussian_rasterization.__init__.py.GaussianRasterizer
</div>
