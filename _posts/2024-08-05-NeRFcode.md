...
- batch : rays_rgb of (N_train * H * W, 3, 3)에서 batch size = N_rand-개만큼 추출하여  
shape (N_rand, 3, 3) $$\rightarrow$$ (3, N_rand, 3)  
...
#### Stratified Sampling for coarse-MLP

#### Inverse-transform Sampling for fine-MLP
